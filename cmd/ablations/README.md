...
| `train_no_ed_training_no_memory_30b.sh` | Disable ED updates and memory | Reconstructed |
...
The solve-rate command selects the plateau component with weight `1.0`
and sets regret, micro-LP, and frontier weights to zero.

The `learning_potential` mode maintains fast and slow performance EMAs,
