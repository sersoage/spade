...
echo "============================================"
echo "SPADE Training (Tinker Backend)"
...
OUTPUT_DIR="${OUTPUT_DIR:-./experiments/spade_tinker/qwen3_30b_a3b_instruct_$(date +%Y%m%d_%H%M%S)}"
...
echo "Starting SPADE training with Tinker..."
echo "Games will be generated on-the-fly during training."
echo ""

python3 train_spade_tinker.py \
    ...
    wandb_project="spade" \
    wandb_name="spade_tinker_qwen3_30b_a3b_instruct_$(date +%Y%m%d_%H%M%S)" \
    use_weave=true \
