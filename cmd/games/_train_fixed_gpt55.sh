...
OUTPUT_DIR="${OUTPUT_DIR:-/scratch/spade_paper_fixed_gpt55_${FIXED_MODEL_SIZE}/$(date +%Y%m%d_%H%M%S)}"
...
SPADE_ARGS=(
   ...
   --spade-max-context-length "${MAX_CONTEXT_LENGTH}"
   --spade-max-turns "${MAX_TURNS}"
   --spade-gamma 0.99
...
RAY_JOB_ID="spade_fixed_gpt55_${FIXED_MODEL_SIZE}_$$"
