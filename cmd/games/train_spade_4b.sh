...
SPADE_ARGS=(
   ...
   --spade-max-turns 25
   --spade-gamma 0.99
   --spade-game-regeneration-interval 4
   ...
   --spade-hint-plays-per-game 16   # matched to trajectories-per-game (16) for clean regret
   --spade-proposer-training-delay 4   # == regen (matched-timing regret at offset 0)
)
