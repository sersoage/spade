"""Offline unit tests for spade.core.eval.tau2_evaluator.
...
import spade.core.eval.tau2_evaluator as te
from spade.core.eval.tau2_evaluator import (
    SGLANG_MODEL_NAME,
    Tau2EvalResult,
    Tau2Evaluator,
)
from spade.core.eval.tau2_tasks import Tau2TaskSpec
