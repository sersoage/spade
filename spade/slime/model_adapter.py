...
This adapter wraps Slime's SGLang HTTP client to provide a unified interface for SpadeOrchestrator.
"""
...
class SlimeModelAdapter(ModelAdapter):
    ...
    ModelAdapter interface for SpadeOrchestrator. It uses async HTTP calls
