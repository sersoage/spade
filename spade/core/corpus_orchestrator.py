...
Subclass of SpadeOrchestrator that overrides _generate_single_game_async
...
from spade.core.prompts.corpus_template import generate_corpus_grounded_prompt
...
from spade.core.envs.synthetic_game_env import criteria_throw_at_reset

logger = logging.getLogger(__name__)


class CorpusGroundedOrchestrator(SpadeOrchestrator):
    ...
    is inherited from SpadeOrchestrator.
    """
    ...
    async def _generate_single_game_async(
        ...
        # Match the dispatch in SpadeOrchestrator._generate_single_game_async
        ...
        for attempt in range(max_attempts):
            ...
            if game_type == "tool_use":
                ...
                # Dispatch single-task vs multi-turn variant via SPADE_MULTITURN_ENV_GEN env var
