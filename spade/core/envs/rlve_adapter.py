...
RLVE is vendored in-tree at spade/external/rlve/ (Gym/ only, no benchmarks).
Source: https://github.com/Zhiyuan-Zeng/RLVE
Import path: spade.external.rlve.Gym.environments.identifier2environment
...
from spade.core.utils.game_utils import extract_boxed_answer
...
def _get_rlve_environments() -> Dict[str, Any]:
    ...
    try:
        ...
        raise ImportError(
            "RLVE not found at spade/external/rlve/. Re-vendor Gym/ from "
...
def _get_rlve_controllers() -> Dict[str, Any]:
    ...
    try:
        ...
        raise ImportError(
            "RLVE parameter controllers not found at spade/external/rlve/Gym/."
        ) from e
...
class RlveGymWrapper:
    ...
    def step(self, action: str) -> Tuple[str, float, bool, bool, Dict[str, Any]]:
        ...
        # Convert \boxed{} to <answer> tags so SPADE can use \boxed{} uniformly.
