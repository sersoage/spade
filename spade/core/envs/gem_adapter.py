...
class SpadeReasoningGymEnv(ReasoningGymEnv):
...
_SPADE_CUSTOM_ENVS = {
    ...
    "rg:graph_color-easy": (
        "spade.core.envs.gem_adapter:SpadeReasoningGymEnv",
    ...
    "eval:GPQA-Diamond": (
        "spade.core.eval.boxed_qa_env:BoxedQaEnv",
    ...
    "mcq:GPQA-Diamond": (
        "spade.core.eval.boxed_qa_env:McqJsonQaEnv",
        {"dataset_name": "fingertap/GPQA-Diamond", "split": "test",
         "question_key": "question", "answer_key": "answer"},
    ),
    ...
    "mcq:GPQA-Diamond-official": (
        "spade.core.eval.boxed_qa_env:GpqaOfficialMcqEnv",
    ...
    "mcq:GPQA-Diamond-scieval": (
        "spade.core.eval.boxed_qa_env:GpqaScievalMcqEnv",
        {"dataset_name": "Idavidrein/gpqa", "config_name": "gpqa_diamond",
         "split": "train", "shuffle_seed": 42},
    ),
    ...
    "eval:LiveCodeBench-v6": (
        "spade.core.eval.livecodebench_env:LiveCodeBenchEnv",
        {"release_version": "release_v6"},
    ),
}

for _env_id, (_entry_point, _kwargs) in _SPADE_CUSTOM_ENVS.items():
    try:
...
def _register_rg_hard_split() -> int:
    ...
    for name, params in A3_HARD_CONFIGS.items():
        ...
        try:
            gem_register(
                env_id, "spade.core.envs.gem_adapter:SpadeReasoningGymEnv",
...
ENV_REGISTRY["eval:CodeContest"] = EnvSpec(
    id="eval:CodeContest",
    entry_point="spade.core.eval.codecontest_env:SpadeCodeContestEnv",
