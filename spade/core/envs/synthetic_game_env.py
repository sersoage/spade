...
class SyntheticGameEnv:
    ...
    def _load_game_from_code(self, code: str, max_steps: int = 1000, respect_game_max_turns: bool = False):
        """Dynamically load game from code string and validate it.

        Raises an exception if the game is invalid; there is no fallback.
        """
        ...
        try:
            from spade.core.envs import tool_use_base_env as _tu_mod
        ...
        # Step 5: Run reset()/step() to verify the game executes.
    ...
    def step(self, action: str) -> Tuple[str, float, bool, bool, Dict]:
        """Execute one step in the environment with error handling."""
        self.current_step += 1
