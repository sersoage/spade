...
from spade.core.types import Trajectory, SpadeConfig
...
def generate_games_batched(
    ...
    Args:
        ...
        config: SpadeConfig with temperature/top_p/max_tokens settings
...
def play_games_batched(
    ...
    Args:
        model: Model adapter with generate_batch method
        config: SpadeConfig with temperature/top_p/max_tokens/max_turns settings
