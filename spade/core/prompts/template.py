...
def apply_qwen3_game_template(observation: str) -> str:
    """Apply Qwen3 template for language games - SPADE-specific variant."""
    return (
...
#
# Used when --spade-game-type tool_use.
...
def apply_qwen3_tool_use_game_generation_template(prompt: str) -> str:
    ...
    Used when --spade-game-type tool_use. Optimized for Qwen3's
